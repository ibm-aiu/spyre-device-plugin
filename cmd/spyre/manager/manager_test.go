...
var (
	...
	perDevicePoolNames = []string{
		"spyre_pf_0000_1a_00.0", "spyre_pf_0000_1c_00.0",
		"spyre_pf_0000_1d_00.0", "spyre_pf_0000_1e_00.0",
		"spyre_pf_0000_3d_00.0", "spyre_pf_0000_3f_00.0",
		"spyre_pf_0000_40_00.0", "spyre_pf_0000_41_00.0"}
	vfPerDevicePoolNames = []string{
		"spyre_vf_0000_1a_00.0", "spyre_vf_0000_1c_00.0",
		"spyre_vf_0000_1d_00.0", "spyre_vf_0000_1e_00.0",
		"spyre_vf_0000_3d_00.0", "spyre_vf_0000_3f_00.0",
		"spyre_vf_0000_40_00.0", "spyre_vf_0000_41_00.0"}
	isolatedVfPerDevicePoolNames = []string{
		"spyre_vf_0001_00_00.0", "spyre_vf_0002_00_00.0",
		"spyre_vf_0003_00_00.0", "spyre_vf_0004_00_00.0",
		"spyre_vf_0005_00_00.0", "spyre_vf_0006_00_00.0",
		"spyre_vf_0007_00_00.0", "spyre_vf_0008_00_00.0"}
...
var _ = Describe("Manager", Ordered, func() {
	...
	Context("with topology file", func() {
		...
		Context("virtual devices", Ordered, func() {
			...
			It("can ignore vf resource", func() {
				err := os.Setenv(spyrev1alpha1.DisableVfMode.EnvKey(), spyreconst.ModeEnabledValue)
		...
		Context("Isolated VF", Ordered, func() {
			...
			DescribeTable("can correctly advertise", func(perDevice bool, topologyAware bool, expectedPoolNames []string) {
				if perDevice {
					err := os.Setenv(spyrev1alpha1.PerDeviceAllocationMode.EnvKey(), spyreconst.ModeEnabledValue)
					Expect(err).NotTo(HaveOccurred())
				}
				if topologyAware {
					err := os.Setenv(spyrev1alpha1.TopologyAwareAllocationMode.EnvKey(), spyreconst.ModeEnabledValue)
					Expect(err).NotTo(HaveOccurred())
				}
				rsList := initManagerAndGetResourceServers(vfConfigFileName)
				Expect(rsList).Should(HaveLen(len(expectedPoolNames)))
	...
	Context("hotplug functionality", func() {
		...
		BeforeEach(func() {
			err := os.Setenv(spyrev1alpha1.ReservationMode.EnvKey(), spyreconst.ModeEnabledValue)
			Expect(err).NotTo(HaveOccurred())
