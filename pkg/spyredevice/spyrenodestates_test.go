...
var _ = Describe("SpyreNodeStates", func() {
	...
	DescribeTable("updateSpyreInterfacesChanges", func(nsSpec spyrev1alpha1.SpyreNodeStateSpec,
		...
		specChanged, statusChanged := updateSpyreInterfacesChanges(
			ns, spyreInterfaceMap, spyreSSAInterfaceMap, unhealthyDevices)
	...
	DescribeTable("updateSpyreInterfacesWithTopo with SpyreVfDevices(Isolated VF)",
	...
	DescribeTable("updateSpyreInterfacesWithTopo with initial change flag",
	...
	DescribeTable("updateSpyreInterfacesWithTopo with complex device configurations",
		func(topoVersion float64, oldTopoDevices, newTopoDevices map[string]pcitopov2.Device, expectedChange bool) {
